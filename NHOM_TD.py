...
def thuat_toan_ERD(n,pj,dj):
    ThuTu = [i for i in range(1,len(pj)+1)]
    Cj = 0
    ThoiGianKetThuc = []
    ThoiGianTreHan = []
    C_Total = 0
    ...
    vetkERD(n,pj,dj)
    tieude = "Hàm mục tiêu là: %d"%(C_Total)
    gantt(BoSo,pj,C_Total)
...
def thuat_toan_EDD(n,pj,dj):
    ...
    tieude = "Hàm mục tiêu là: %d"%(L_max)
...
fontto = pygame.font.Font("Raleway-Medium.ttf", 30)
fontnho = pygame.font.Font("Raleway-Medium.ttf", 20)
